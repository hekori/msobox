...
# local imports
from ocms_snopt import OCMS_snopt
from ocms_indegrator import OCMS_indegrator
...
if __name__ == "__main__":
    ...
    problem     = OCMS_indegrator(path="./examples/chemie/", minormax="max", NX=2, NG=0, NP=1, NU=1, bc=bc, ts=ts, NTSI=5)
    x0          = [1, 0]
    xend        = [None, None]
    p           = np.array([3.5])
    q0          = 1 * np.ones((problem.NQ,))
